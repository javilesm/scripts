...
# Solicitar el nombre de usuario, la base de datos y el host deseado para cada usuario
...
# Guardar el nombre de usuario, la contraseña, la base de datos, el host y el privilegio en un archivo csv
