...
def obtener_encabezados_csv(directorio_csv, Headings_Dir):
    ...
    tipos_de_datos_sql = {
        ...
        'object': 'VARCHAR(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL',
        'datetime64': 'DATETIME',
        'date': 'DATE',
        ...
        with open(ruta_archivo_texto, 'w', encoding='utf-8') as texto_file:
            ...
            for i, col in enumerate(df.columns):
                ...
                if (
                    ...
                    tipo_dato_sql = tipos_de_datos_sql.get(str(tipo_dato), 'VARCHAR(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL')
